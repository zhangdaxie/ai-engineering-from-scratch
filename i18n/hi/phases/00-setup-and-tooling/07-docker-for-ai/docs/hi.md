...
**macOS / Apple Silicon (M1/M2/M3/M4):**`--platform=linux/amd64`पर `FROM`यह लाइन है जो इस निर्माण को एक मैक पर सफल बनाता है। CUDA बेस छवि भी एक arm64 संस्करण भेजता है और Docker डेस्कटॉप इसे स्वचालित रूप से Apple सिलिकॉन पर चुनता है, लेकिन PyTorch अपने `cu124`केवल x86_64 के लिए पहियों, तो `pip install torch==2.6.0+cu124`परत विफलता के साथ `No matching distribution found for torch==2.6.0+cu124`. मंच को पिन करना x86_64 छवि खींचता है और इसे अनुकरण के तहत चलाता हैः निर्माण धीमा है और कंटेनर में कोई GPU नहीं है (एक मैक पर किसी भी तरह से कोई CUDA नहीं है) । ड्रॉप `--gpus all``docker run`मैक पर नीचे दिए गए कमांड्स के लिए. एप्पल सिलिकॉन पर जीपीयू काम करने के लिए, एमपीएस बिल्ड के साथ पाठ 01 को मूल रूप से चलाएं और एनवीआईडीआईए जीपीयू के साथ x86_64 लिनक्स होस्ट के लिए इस छवि को रखें।
